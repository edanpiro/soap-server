 ...
 * 2024-10-21T14:11:20.665-05:00
 * Generated source version: 3.3.0
 *
 */
@WebServiceClient(name = "SumService",
                  wsdlLocation = "file:/Users/epimentel/idat/semana4/soap-server/src/main/resources/wsdl/SumService.wsdl",
                  targetNamespace = "http://idat.pe/SumService/wsdl")
public class SumService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://idat.pe/SumService/wsdl", "SumService");
    public final static QName SumServiceSOAPBinding = new QName("http://idat.pe/SumService/wsdl", "SumServiceSOAPBinding");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/epimentel/idat/semana4/soap-server/src/main/resources/wsdl/SumService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SumService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/epimentel/idat/semana4/soap-server/src/main/resources/wsdl/SumService.wsdl");
        }
        WSDL_LOCATION = url;
    }
